...
//       .select()
//       .from(users) // ya aapka user table
...
//     // Send OTP via email
//     try {
//       await sendOTPEmail(email, otpCode, name || existingUser[0]?.firstName);
...
//       return res.status(400).json({ error: "Email, new password are required" });
//     }
