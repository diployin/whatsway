...
import { TrendingUp, Users, ShoppingCart, Calendar, Heart, GraduationCap, ArrowRight, ExternalLink } from 'lucide-react';
  ...
  const caseStudies = [
    {
      ...
      solution: 'Implemented automated cart recovery campaigns and personalized product recommendations',
      results: {
      ...
      testimonial: {
        quote: "WPSaaS transformed our customer engagement. The automated workflows saved us hours while dramatically increasing our sales.",
    ...
    },
    {
      ...
      solution: 'Automated appointment reminders and confirmation system via WhatsApp',
      results: {
      ...
      testimonial: {
        quote: "Our patients love the WhatsApp reminders. It's convenient for them and has significantly improved our scheduling efficiency.",
    ...
    },
    {
      ...
      testimonial: {
        quote: "Parents are now actively involved in their children's education journey. The communication has never been better.",
    ...
    },
    {
      ...
      solution: 'Loyalty program notifications and personalized menu recommendations',
      results: {
      ...
      testimonial: {
        quote: "Our customers love getting personalized menu suggestions. It's like having a personal food concierge.",
        author: "David Park",
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            with WPSaaS WhatsApp marketing platform.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {caseStudies.map(study => (
              <div key={study.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-1">
                <div className="relative">
                  ...
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                    <span className="text-sm font-medium text-gray-700">{study.industry}</span>
                  </div>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-2">{selectedStudy.title}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">{selectedStudy.challenge}</p>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {selectedStudy.results.metrics.map((metric: any, index: number) => (
                      <div key={index} className="bg-gray-50 p-4 rounded-lg">
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-gray-700 font-medium">{metric.label}</span>
                          <span className="text-green-600 font-bold">{metric.increase}</span>
                        </div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg mb-8">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">{selectedStudy.testimonial.author}</div>
                    <div className="text-gray-600">{selectedStudy.testimonial.role}</div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { number: '85%', label: 'Customer Engagement' },
