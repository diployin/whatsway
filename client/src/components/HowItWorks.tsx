  ...
  const steps = [
    {
      ...
      description: 'Bring your own WhatsApp Business API from Meta and connect it to our platform in seconds',
      details: [
    ...
    },
    {
      ...
      description: 'Upload your customer database or sync directly from your CRM and existing tools',
      details: [
    ...
    },
    {
      ...
      description: 'Design beautiful messages with our drag-and-drop builder and launch targeted campaigns',
      details: [
    ...
    },
    {
      ...
      description: 'Monitor performance in real-time and optimize your campaigns for better results',
      details: [
        'Real-time analytics',
        'Delivery tracking',
        'Engagement metrics',
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our streamlined onboarding process gets you up and running with WhatsApp marketing 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className={`p-8 rounded-2xl ${steps[activeStep].bgColor} transition-all duration-500`}>
              <div className="flex items-center space-x-4 mb-6">
                <div className={`p-4 rounded-xl bg-gradient-to-r ${steps[activeStep].color} shadow-lg`}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2">{steps[activeStep].description}</p>
                </div>
              </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-2xl shadow-2xl">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-gray-400 text-sm ml-4">WhatsApp Business Dashboard</span>
              </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-8 rounded-2xl">
            ...
            <p className="text-gray-600 mb-6">
              Join thousands of businesses already using our platform to scale their WhatsApp marketing
            </p>
