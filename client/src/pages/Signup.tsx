...
import { Mail, Lock, Eye, EyeOff, MessageCircle, ArrowRight, User, Building } from 'lucide-react';
import Footer from '@/components/Footer';
import Header from '@/components/Header';
const Signup: React.FC = () => {
  const [, setLocation] = useLocation();  // Wouter hook: get setter for navigation
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to dashboard on successful signup using Wouter navigation
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">
            What you get with Whatsway
          </h3>
          <div className="space-y-3">
            {[
              'Free forever plan with 1,000 contacts',
              'Connect your own WhatsApp Business API',
