...
import { FaComment, FaEdit, FaTrash, FaEllipsisH } from "react-icons/fa";
              ...
              users.map((user, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Groups */}
                    <td className="px-4 py-3 text-sm text-gray-500 italic">{groups}</td>
                    ...
                    <td className="px-4 py-3 flex justify-center space-x-4 text-gray-500">
                      ...
                      <FaEllipsisH className="hover:text-gray-700 cursor-pointer" title="More" />
                    </td>
                  </tr>
                );
              })
